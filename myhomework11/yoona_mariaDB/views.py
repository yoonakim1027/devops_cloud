...
from yoona_mariaDB.models import Post

def index(request):
    return render(request, "yoona_mariaDB/index.html")
# render(인자 두개만 넣음)
...
# q라는 문자열이 포함이 된다면?
    ...
    return render(request, "yoona_mariaDB/post_list.html", {
        "post_list": qs,
    }) #두번째 인자에 앱이름
...
def post_detail(request: HttpRequest, pk:int) -> HttpResponse:
    ...
    return render(request, "yoona_mariaDB/post_detail.html",{
        "post": post,
    })
